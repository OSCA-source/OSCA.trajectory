# Orchestrating trajectory analyses 

This repository contains a Bioconductor package to deploy the **Trajectory** subbook of the **Orchestrating Single-Cell Analysis** book.
...
rebook::configureBook(prefix="Trajectory")
```
